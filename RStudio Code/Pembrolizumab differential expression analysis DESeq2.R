...
# volcano plot
old.pal <- palette(c("#00BFFF", "#FF3030")) # downregulated - upregulated colors
...
legend("bottomright", title=paste("Padj<", 0.05, sep=""), legend=c("downregulated", "upregulated"), pch=20,col=1:2)
